(function (base) {
        ...
        updateSummary: function() {
            ...
            TTLChart.selectedNets.forEach( function (net) {
                ...
                $(TTLChart.view.summary).append(
                    "<ul class='ttl-summary'>"
                    +"<li class='time'>"+net.time+"</li>"
                    /*
                     +"<li class='bw'>"+net.bw+"</li>"
                     +"<li class='rtt'>"+net.rtt+"</li>"
                     +"<li class='windows'>"+net.rwnd+" kB / "+net.cwnd+"</li>"
                     +"<li class='mtu'>"+net.mtu+"</li>"
                     */
    ...
    d3.json(TTLChart.chartUrl,function (error,json) {
        ...
        vg.parse.spec(TTLChart.spec, function(chart) {
            TTLChart.chart = chart({data: TTLChart.data, el:$('[data-chart="vega"]',base).get(0)}).update();
        });
    });
...
})($('script[src="js/ttl-chart.js"]').get(0).parentNode)